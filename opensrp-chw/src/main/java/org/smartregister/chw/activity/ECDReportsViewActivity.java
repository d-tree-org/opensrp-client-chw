...
public class ECDReportsViewActivity extends ChwReportsViewActivity {
    public static void startMe(Activity activity, String reportPath, int reportTitle, String reportDate) {
        Intent intent = new Intent(activity, ECDReportsViewActivity.class);
        ...
        intent.putExtra(ARG_REPORT_TYPE, Constants.ReportConstants.ReportTypes.ECD_REPORT);
